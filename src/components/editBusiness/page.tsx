...
const EditBusinessPage: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault();
        if (!userId) return;
        const updatedBusiness = { business_description: description, business_address: address, business_phonenumber: phonenumber };
                ...
                <Modal.Body>
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            ...
                            <TextInput id="phonenumber" type="text" value={phonenumber} onChange={(e) => setPhonenumber(e.target.value)} />
                        </div>
